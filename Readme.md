...
# Parsing + Configuration Script – RSSI - Rev. A

This **Parsing + Configuration** script is designed for the **RSSI** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – RSSI Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **RSSI** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
